...
public class LikeDao extends AbstractDao<Like, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LikeUserId = new Property(2, String.class, "likeUserId", false, "LIKE_USER_ID");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LIKES\" (" + //
                ...
                "\"LIKE_USER_ID\" TEXT);"); // 2: likeUserId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Like entity) {
        ...
        String likeUserId = entity.getLikeUserId();
        if (likeUserId != null) {
            stmt.bindString(3, likeUserId);
        }
    }
    ...
    public Like readEntity(Cursor cursor, int offset) {
        Like entity = new Like( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // likeUserId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Like entity, int offset) {
        ...
        entity.setLikeUserId(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
